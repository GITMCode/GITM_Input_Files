...
${GITM}/srcPython/gitm_makerun.py -gitm=${GITM} -output=UAM.in -imf=find -sme=sme20230323.dat -fism -dynamo -fang -fta -nlats=${LATS} -nlons=${LONS} -3dall=900 -2danc=900 -restart -cputimemax=${WALLTIME} -restarttime=${RESTART} ${START} ${END}
