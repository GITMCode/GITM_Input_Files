...
module ModInputs
  ...
  ! DSO 2024-08-16: Implementing PulsatingAurora
  logical :: UsePulsatingAurora = .false.
  real :: PAAveE = 20.0
  real :: PAEFlux = 2.0
  real :: PAPeriod = 30.
  real :: PAMltCenter = 0.5
  real :: PALatCenter = 65.0
  real :: PAMltHalfWidth = 0.1
  real :: PALatHalfWidth = 1.0
